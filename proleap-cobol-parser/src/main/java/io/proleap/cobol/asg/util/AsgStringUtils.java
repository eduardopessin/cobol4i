...
public class AsgStringUtils {
	...
	public static Boolean parseBoolean(final String str) {
		...
		final String trimmed = str.trim().toUpperCase();

		// IBM ILE COBOL boolean literals: B"1", B'1', B"0", B'0'
		if (trimmed.startsWith("B")) {
			final String inner = trimmed.substring(1).replace("\"", "").replace("'", "");
			return "1".equals(inner);
		}
