...
public interface WriteStatement extends Statement {
	...
	ValueStmt getFormatPhrase();

	void setFormatPhrase(ValueStmt formatPhrase);

	Call getIndicatorsPhrase();

	void setIndicatorsPhrase(Call indicatorsPhrase);

	boolean isSubfile();

	void setSubfile(boolean subfile);

	ValueStmt getTerminalPhrase();

	void setTerminalPhrase(ValueStmt terminalPhrase);

	ValueStmt getStartingPhrase();

	void setStartingPhrase(ValueStmt startingPhrase);
}
