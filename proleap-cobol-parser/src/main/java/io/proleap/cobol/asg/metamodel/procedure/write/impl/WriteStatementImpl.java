...
public class WriteStatementImpl extends StatementImpl implements WriteStatement {
	...
	protected ValueStmt formatPhrase;

	protected From from;

	protected Call indicatorsPhrase;
	...
	protected ValueStmt startingPhrase;

	protected final StatementType statementType = StatementTypeEnum.WRITE;

	protected boolean subfile;

	protected ValueStmt terminalPhrase;
	...
	@Override
	public ValueStmt getFormatPhrase() {
		return formatPhrase;
	}

	@Override
	public void setFormatPhrase(final ValueStmt formatPhrase) {
		this.formatPhrase = formatPhrase;
	}

	@Override
	public Call getIndicatorsPhrase() {
		return indicatorsPhrase;
	}

	@Override
	public void setIndicatorsPhrase(final Call indicatorsPhrase) {
		this.indicatorsPhrase = indicatorsPhrase;
	}
	...
	@Override
	public void setSubfile(final boolean subfile) {
		this.subfile = subfile;
	}

	@Override
	public ValueStmt getTerminalPhrase() {
		return terminalPhrase;
	}

	@Override
	public void setTerminalPhrase(final ValueStmt terminalPhrase) {
		this.terminalPhrase = terminalPhrase;
	}

	@Override
	public ValueStmt getStartingPhrase() {
		return startingPhrase;
	}

	@Override
	public void setStartingPhrase(final ValueStmt startingPhrase) {
