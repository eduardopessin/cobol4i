...
public interface CobolParserParams {
	...
	Map<String, File> getCopyBookLibraryMappings();

	File getDdsSchemaDirectory();
	...
	void setCopyBookLibraryMappings(Map<String, File> libraryMappings);

	void setDdsSchemaDirectory(File ddsSchemaDirectory);
