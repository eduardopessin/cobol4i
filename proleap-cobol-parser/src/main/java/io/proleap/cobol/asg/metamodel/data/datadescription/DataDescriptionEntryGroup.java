...
public interface DataDescriptionEntryGroup extends DataDescriptionEntry {
	...
	FormatClause addFormatClause(DataFormatClauseContext ctx);

	GlobalClause addGlobalClause(DataGlobalClauseContext ctx);

	IndicatorClause addIndicatorClause(DataIndicatorClauseContext ctx);
	...
	LikeClause addLikeClause(DataLikeClauseContext ctx);
