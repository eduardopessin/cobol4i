...
public class CobolParserParamsImpl implements CobolParserParams {
	...
	protected Map<String, File> copyBookLibraryMappings = new HashMap<>();

	protected File ddsSchemaDirectory;
	...
	@Override
	public Map<String, File> getCopyBookLibraryMappings() {
		return copyBookLibraryMappings;
	}

	@Override
	public File getDdsSchemaDirectory() {
		return ddsSchemaDirectory;
	}
	...
	@Override
	public void setCopyBookLibraryMappings(final Map<String, File> libraryMappings) {
		this.copyBookLibraryMappings = libraryMappings;
	}

	@Override
	public void setDdsSchemaDirectory(final File ddsSchemaDirectory) {
		this.ddsSchemaDirectory = ddsSchemaDirectory;
	}
