...
public class CobolProcedureStatementVisitorImpl extends AbstractCobolParserVisitorImpl {
	...
	@Override
	public Boolean visitCommitStatement(final CobolParser.CommitStatementContext ctx) {
		final Scope scope = findScope(ctx);

		scope.addCommitStatement(ctx);
	...
	@Override
	public Boolean visitRollbackStatement(final CobolParser.RollbackStatementContext ctx) {
		final Scope scope = findScope(ctx);

		scope.addRollbackStatement(ctx);
